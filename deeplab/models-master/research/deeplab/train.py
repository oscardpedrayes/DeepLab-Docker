...
flags.DEFINE_integer('save_interval_secs', 60*10,
                     'How often, in seconds, we save the model to disk.')

flags.DEFINE_integer('save_summaries_secs', 30,
                     'How often, in seconds, we compute the summaries.')#600 
...
flags.DEFINE_float('adam_learning_rate', 0.00005,
...
def _build_deeplab(iterator, outputs_to_num_classes, ignore_label):
  ...
  #[0.6699, 1.9710, 0.0000], # DOF-BINARY
  #[0.5748,3.8430, 0.0000], #AVI-BINARY

  #[0.5402, 6.7145, 0.0000], #GIJ-BINARY
  #[0.07446, 0.92553, 0.0000], #GIJ-BINARY-NORM-MFW
  #[0.05211, 0.94788, 0.0000], #GIJ-BINARY-NORM-IFW
  #[0.2, 0.8, 0.0000], #GIJ-BINARY-NORM-IFW
  #[0.5385, 6.9915, 0.0000], #GIJ-BINARY-MFW+500-mistmatch
  #[0.07151, 0.92848, 0.0000], #GIJ-BINARY-NORM-MFW+500-mismatch
  #[0.07353, 0.92646, 0.0000], #GIJ-BINARY-NORM-MFW+500
  #[0.07262, 0.92737, 0.0000], #GIJ-BINARY-NORM-MFW+1500

  #[0.2970, 2.4922, 1.0000, 1.5924, 0.2649, 0.0000], #GIJ 
  #[1.1469, 0.9213, 1.0934, 0.5683, 1.0000], #DOF
  #[0.6182,3.9584,0.6904,11.2659,1.8127,0.6729, 0.0000] #AVI,

  # NEW AVI ORIGINAL   0.5668    4.2417 /   NEW SIN EMISION  0.5628    4.4825
  # NORMALIZED 0.11787 0.88212 / 0.11154 0.88845
  ...
  for output, num_classes in six.iteritems(outputs_to_num_classes):
    train_utils.add_softmax_cross_entropy_loss_for_each_scale(
        ...
        num_classes,
        ignore_label,
        #loss_weight=[0.4624, 0.6109, 2.7846, 2.7542], 
        loss_weight=[0.4297, 1.0000, 0.6309, 2.6824, 3.4774, 0.0000], 
        #loss_weight=[0.4140, 3.2059, 0.7719, 10.2846, 1.4194, 0.4181, 0.000], #[0.048, 0.594, 0.357, 0.000], #[0.1352, 1.6625, 1.0000, 0.0000], #AVI_LEVELS_LM
