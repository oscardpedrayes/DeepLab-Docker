...
_EMID='emid'
_EMID_GIJ='emid-gij'
_EMID_AVI_LEVELS='emid-avi-levels-binary'
...
def create_pnoa_label_colormap():
  """Creates a label colormap used in PNOA segmentation benchmark.
  ...
  colormap = np.zeros((256, 3), dtype=np.uint8)
  #DOF
  #colormap[0] = [119, 11, 32]
  #colormap[1] = [150, 100, 100]
  #colormap[2] = [0, 0, 142]
  #colormap[3] = [70, 70, 70]
  ...
  #colormap[0] = [0, 0, 0]
  #colormap[1] = [255, 0, 0]
  #colormap[2] = [255, 127, 0]
  #colormap[3] = [255, 255, 0]
  #colormap[4] = [127, 255, 0]
  #colormap[5] = [0, 255, 0]
  #colormap[6] = [0, 255, 127]
  #colormap[7] = [255, 0, 255]
...
def create_emid_avi_levels_label_colormap():
  """Creates a label colormap used in PNOA segmentation benchmark.
...
def create_emid_label_colormap():
  """Creates a label colormap used in EMID segmentation benchmark.
  ...
  colormap[1] = [0, 60, 100]
  colormap[2] = [150, 100, 100]
  colormap[3] = [255, 74, 74]
  colormap[4] = [0, 0, 142]
  colormap[5] = [70, 70, 70]
  colormap[6] = [255, 255, 255]
  return colormap

def create_emidgij_label_colormap():
  """Creates a label colormap used in EMID segmentation benchmark.
...
def create_label_colormap(dataset=_PASCAL):
  ...
  if dataset == _ADE20K:
    ...
    return create_pnoa_label_colormap()
  elif dataset == _EMID:
    return create_emid_label_colormap()
  elif dataset == _EMID_GIJ:
    return create_emidgij_label_colormap() 
  elif dataset == _EMID_AVI_LEVELS:
    return create_emid_avi_levels_label_colormap() 
  else:
