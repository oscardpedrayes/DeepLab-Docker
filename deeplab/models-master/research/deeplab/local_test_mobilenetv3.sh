...
#python3.7 "${WORK_DIR}"/model_test.py #-v
...
EXP_FOLDER="exp/train_on_trainval_set_mobilenetv3_large"
...
python3.7 "${WORK_DIR}"/train.py \
  ...
  --fine_tune_batch_norm=true \ #--tf_initial_checkpoint="${INIT_FOLDER}/${CKPT_NAME}/model.ckpt-30000" \
